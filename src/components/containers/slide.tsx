          ...
          <CarouselItem className="w-full">
            <div className="flex flex-col w-full items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              ...
              <div className="flex flex-col p-4 justify-between leading-normal w-full">
                ...
                <Link href={"http://portifoliogeisabitt.s3-website.us-east-2.amazonaws.com/"} target="blank">
          ...
          <CarouselItem className="w-full">
            <div className="flex flex-col w-full items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              ...
              <div className="flex flex-col p-4 justify-between leading-normal w-full">
                ...
                <Link href={"https://www.cctf.com.br/"} target="blank">
                  <Button>Ver Site</Button>
                </Link>
              </div>
            </div>
          ...
          <CarouselItem className="w-full">
            <div className="flex flex-col w-full items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              ...
              <div className="flex flex-col p-4 justify-between leading-normal w-full">
                ...
                <Link href={"https://publist-rho.vercel.app/"} target="blank">
                  <Button>Ver Site</Button>
                </Link>
              </div>
            </div>
          ...
          <CarouselItem className="w-full">
            <div className="flex flex-col w-full items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              ...
              <div className="flex flex-col p-4 justify-between leading-normal w-full">
                ...
                <Link href={"https://geisabitt.github.io/animals-langding-page/"} target="blank">
                  <Button>Ver Site</Button>
                </Link>
              </div>
            </div>
          ...
          <CarouselItem className="w-full">
            <div className="flex flex-col w-full items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              ...
              <div className="flex flex-col p-4 justify-between leading-normal w-full">
                ...
                <Link href={"https://geisabitt.github.io/api-consume-makeup/"} target="blank">
                  <Button>Ver Site</Button>
                </Link>
              </div>
            </div>
